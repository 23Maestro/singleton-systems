...
Keep these dimensions aligned:

- `platform`: where it will publish.
- `reference_set`: examples used for structure, not copied voice or claims.
- `direct_style`: the intended level of directness.
- `post_format`: text, carousel, image, short video, or other native shape.
- `attack_type`: the specific problem, misconception, or workflow friction.

...
insert into public.cerebral_routes (
  ...
  ('agency-growth', array['cold email','outbound','prospecting','ICP','ideal customer','objection','direct lead','sales sequence'], 'all_buckets', 'Opportunity HQ', 'Plan or execute direct B2B client acquisition from real signals and portfolio.', 'task', array['s-systems:agency-growth'], 'Final Human Pass before showing copy as final.', 30, true, '2026-07-22-systems-source-consolidation'),
  ('job-application', array['job application','resume','job post','survival job','blue collar job','white collar job'], 'all_buckets', 'Opportunity HQ', 'Tailor a truthful application or resume angle.', 'task', array['s-systems:job-application-resume'], 'Verify claims against source evidence before final.', 40, false, '2026-07-22-systems-source-consolidation'),
  ...
  ('offer-content', array['linkedin post','instagram','content idea','social post','content calendar','portfolio content'], 'all_buckets', 'Docs/skills', 'Turn documented portfolio work into useful offer-aligned content.', 'portfolio', array['s-systems:offer-portfolio-content'], 'Final Human Pass before final.', 55, true, '2026-07-22-systems-source-consolidation'),
  ...
  ('website-offer', array['website','landing page','hero','offer wording','workflow cleanup offer'], 'all_buckets', 'Docs/skills', 'Make an offer or site decision from the Singleton Systems business model.', 'operating rule', array['s-systems:singleton-systems'], 'Use documented portfolio work and Final Human Pass for publishable copy.', 75, true, '2026-07-22-systems-source-consolidation'),
  ('eagle-library', array['eagle library','eagle tag','eagle folder','find image','organize asset'], 'Portfolio', 'Eagle', 'Operate the Eagle asset library.', 'portfolio', array['s-systems:eagle'], 'Verify the selected asset before changing metadata.', 80, true, '2026-07-22-systems-source-consolidation')

...
insert into public.cerebral_routes (
  ...
  ('agency-growth', array['cold email','outbound','prospecting','ICP','ideal customer','objection','direct lead','sales sequence'], 'Offer', 'Opportunity HQ', 'Plan or execute direct B2B client acquisition from real signals and portfolio.', 'task', array['s-systems:agency-growth'], 'Final Human Pass before showing copy as final.', 30, true, '2026-07-16'),
  ('job-application', array['job application','resume','job post','survival job','blue collar job','white collar job'], 'Career Jobs', 'Opportunity HQ', 'Tailor a truthful application or resume angle.', 'task', array['s-systems:job-application-resume'], 'Verify claims against source evidence before final.', 40, true, '2026-07-16'),
  ...
  ('portfolio-packaging', array['eagle portfolio','portfolio asset','portfolio asset','project screenshot','workflow demo'], 'Portfolio', 'Eagle', 'Turn a real asset into a portfolio block or claim.', 'portfolio', array['s-systems:career-portfolio-packager','s-systems:eagle'], 'Verify the asset and claim source before publishing.', 50, true, '2026-07-16'),
  ('offer-content', array['linkedin post','instagram','content idea','social post','content calendar','portfolio content'], 'Offer', 'Docs/skills', 'Turn documented portfolio work into useful offer-aligned content.', 'portfolio', array['s-systems:offer-portfolio-content'], 'Final Human Pass before final.', 55, true, '2026-07-16'),
  ...
  ('website-offer', array['website','landing page','hero','offer wording','workflow cleanup offer'], 'Offer', 'Docs/skills', 'Make an offer or site decision from the Singleton Systems business model.', 'operating rule', array['s-systems:singleton-systems'], 'Use documented portfolio work and Final Human Pass for publishable copy.', 75, true, '2026-07-16'),
  ('eagle-library', array['eagle library','eagle tag','eagle folder','find image','organize asset'], 'Portfolio', 'Eagle', 'Operate the Eagle asset library.', 'portfolio', array['s-systems:eagle'], 'Verify the selected asset before changing metadata.', 80, true, '2026-07-16')
...
insert into public.harness_skills (skill_key, activation, reason, source_revision) values
  ('ad-creative-strategist', 'disabled', 'Generic Agency wrapper; offer-portfolio-content owns SSystems portfolio content.', '2026-07-16'),
  ...
  ('career-portfolio-packager', 'core', 'Portfolio and portfolio packaging.', '2026-07-16'),
  ...
  ('content-creator', 'disabled', 'Generic Agency wrapper; offer-portfolio-content owns SSystems content.', '2026-07-16'),
  ...
  ('instagram-curator', 'disabled', 'Generic Agency wrapper; offer-portfolio-content owns SSystems social portfolio.', '2026-07-16'),
  ('job-application-resume', 'core', 'Application and resume work.', '2026-07-16'),
  ('linkedin-content-creator', 'disabled', 'Generic Agency wrapper; offer-portfolio-content owns SSystems LinkedIn portfolio.', '2026-07-16'),
  ('offer-portfolio-content', 'core', 'Portfolio-led content.', '2026-07-16'),

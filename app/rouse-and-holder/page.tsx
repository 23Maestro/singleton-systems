...
.gary-setup-page{max-width:1080px;min-height:100dvh;margin:auto;padding:20px;background:var(--gary-white);color:var(--gary-body);font:15px/1.5 var(--font-geist-sans),Arial,sans-serif;-webkit-font-smoothing:antialiased}
...
.gary-setup-page .kicker{font:700 11px/1.2 var(--font-geist-mono),monospace;letter-spacing:.12em;text-transform:uppercase;color:var(--gary-blue-text)}
...
.gary-setup-page code{font-family:var(--font-geist-mono),monospace;background:var(--gary-wash);border:1px solid #e4e8ef;padding:1px 4px;border-radius:4px;color:var(--gary-ink);font-size:12px}
.gary-setup-page .tree{white-space:pre-wrap;background:var(--gary-ink);color:#fff;border-radius:9px;padding:12px;margin:0;font:12px/1.55 var(--font-geist-mono),monospace}
...
.gary-setup-page .tags{margin:2px 0 7px}.gary-setup-page .tag{display:inline-block;margin:2px 3px 2px 0;padding:3px 8px;border-radius:99px;font:700 11px/1.4 var(--font-geist-mono),monospace;background:#eaf2f8;color:var(--gary-blue-text)}.gary-setup-page .tag:nth-child(2){background:#fff7dc;color:var(--gary-yellow-text)}.gary-setup-page .tag:nth-child(3){background:#fff0ee;color:var(--gary-coral-text)}.gary-setup-page .tag:nth-child(4){background:#eaf8ef;color:var(--gary-green-text)}
.gary-setup-page .note{font-size:12px;color:var(--gary-muted);margin-top:7px}.gary-setup-page .footer{margin-top:10px;font:600 11px/1.2 var(--font-geist-mono),monospace;color:var(--gary-muted);text-align:right}

...
`;case`review_first_implementation_loop`:return`digraph {
    ...
    verify [color="#2d5d39",
        ...
        width=4.445];
    gather [height=2.5,
        label=<<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="4"><TR><TD ROWSPAN="2" WIDTH="106"> </TD><TD ALIGN="TEXT" BALIGN="LEFT"><FONT POINT-SIZE="20">Gather</FONT></TD><TD ROWSPAN="2" WIDTH="16"> </TD></TR><TR><TD ALIGN="TEXT" BALIGN="LEFT"><FONT POINT-SIZE="15" COLOR="#bfdbfe">Collect the real workflow and<BR/>source evidence.</FONT></TD></TR></TABLE>>,
    ...
    draft [color="#7E451D",
        ...
        fontcolor="#FFE0C2",
        height=2.5,
        label=<<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="4"><TR><TD ROWSPAN="2" WIDTH="106"> </TD><TD ALIGN="TEXT" BALIGN="LEFT"><FONT POINT-SIZE="20">Draft</FONT></TD><TD ROWSPAN="2" WIDTH="16"> </TD></TR><TR><TD ALIGN="TEXT" BALIGN="LEFT"><FONT POINT-SIZE="15" COLOR="#f9b27c">Turn the classified workflow into<BR/>useful working material.</FONT></TD></TR></TABLE>>,
    ...
    review [color="#853A2D",
        ...
        fontcolor="#FBD3CB",
        height=2.5,
        label=<<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="4"><TR><TD ROWSPAN="2" WIDTH="106"> </TD><TD ALIGN="TEXT" BALIGN="LEFT"><FONT POINT-SIZE="20">Review</FONT></TD><TD ROWSPAN="2" WIDTH="16"> </TD></TR><TR><TD ALIGN="TEXT" BALIGN="LEFT"><FONT POINT-SIZE="15" COLOR="#f5b2a3">Keep human judgment before<BR/>mutation, sending, or publishing.</FONT></TD></TR></TABLE>>,
...
<g id="node2" class="node">
<title>gather</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="842.88,-361 497,-361 497,-181 842.88,-181 842.88,-361"/>
<text xml:space="preserve" text-anchor="start" x="560.12" y="-265.4" font-family="Arial" font-size="14.00" fill="#eff6ff"> </text>
<text xml:space="preserve" text-anchor="start" x="619.06" y="-283" font-family="Arial" font-size="20.00" fill="#eff6ff">Gather</text>
<text xml:space="preserve" text-anchor="start" x="820.87" y="-265.4" font-family="Arial" font-size="14.00" fill="#eff6ff"> </text>
<text xml:space="preserve" text-anchor="start" x="619.06" y="-260" font-family="Arial" font-size="15.00" fill="#bfdbfe">Collect the real workflow and</text>
<text xml:space="preserve" text-anchor="start" x="619.06" y="-242" font-family="Arial" font-size="15.00" fill="#bfdbfe">source evidence.</text>
</g>
<!-- classify -->
<g id="node3" class="node">
...
<g id="node4" class="node">
<title>draft</title>
<polygon fill="#a35829" stroke="#7e451d" stroke-width="0" points="1841.67,-361 1474.96,-361 1474.96,-181 1841.67,-181 1841.67,-361"/>
<text xml:space="preserve" text-anchor="start" x="1538.07" y="-265.4" font-family="Arial" font-size="14.00" fill="#ffe0c2"> </text>
<text xml:space="preserve" text-anchor="start" x="1597.02" y="-283" font-family="Arial" font-size="20.00" fill="#ffe0c2">Draft</text>
<text xml:space="preserve" text-anchor="start" x="1819.66" y="-265.4" font-family="Arial" font-size="14.00" fill="#ffe0c2"> </text>
<text xml:space="preserve" text-anchor="start" x="1597.02" y="-260" font-family="Arial" font-size="15.00" fill="#f9b27c">Turn the classified workflow into</text>
<text xml:space="preserve" text-anchor="start" x="1597.02" y="-242" font-family="Arial" font-size="15.00" fill="#f9b27c">useful working material.</text>
</g>
<!-- review -->
<g id="node5" class="node">
<title>review</title>
<polygon fill="#ac4d39" stroke="#853a2d" stroke-width="0" points="2365.67,-183 1955.68,-183 1955.68,-3 2365.67,-3 2365.67,-183"/>
<text xml:space="preserve" text-anchor="start" x="2038.75" y="-87.4" font-family="Arial" font-size="14.00" fill="#fbd3cb"> </text>
<text xml:space="preserve" text-anchor="start" x="2097.69" y="-105" font-family="Arial" font-size="20.00" fill="#fbd3cb">Review</text>
<text xml:space="preserve" text-anchor="start" x="2323.71" y="-87.4" font-family="Arial" font-size="14.00" fill="#fbd3cb"> </text>
<text xml:space="preserve" text-anchor="start" x="2097.69" y="-82" font-family="Arial" font-size="15.00" fill="#f5b2a3">Keep human judgment before</text>
<text xml:space="preserve" text-anchor="start" x="2097.69" y="-64" font-family="Arial" font-size="15.00" fill="#f5b2a3">mutation, sending, or publishing.</text>
</g>
<!-- verify&#45;&gt;gather -->
<g id="edge1" class="edge">

...
`;case`ai_workflow_readme_map`:return`digraph {
    ...
    subgraph cluster_aiworkflowsystem {
        ...
        prospectweb [group=aiWorkflowSystem,
            ...
            margin="0.223,0.223",
            width=4.445];
        fastapibridge [color="#7E451D",
            fillcolor="#A35829",
            fontcolor="#FFE0C2",
            group=aiWorkflowSystem,
            height=2.5,
            label=<<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="4"><TR><TD><FONT POINT-SIZE="20">Local FastAPI Bridge</FONT></TD></TR><TR><TD><FONT POINT-SIZE="15" COLOR="#f9b27c">Adapter layer that turns legacy dashboard<BR/>form behavior into repeatable<BR/>request shapes and readback checks.</FONT></TD></TR></TABLE>>,
            likec4_id="aiWorkflowSystem.fastApiBridge",
            likec4_level=1,
            margin="0.223,0.223",
            width=4.445];
        legacylaravel [color="#853A2D",
            fillcolor="#AC4D39",
            fontcolor="#FBD3CB",
            group=aiWorkflowSystem,
            height=2.5,
            label=<<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="4"><TR><TD><FONT POINT-SIZE="20">Legacy Laravel Dashboard</FONT></TD></TR><TR><TD><FONT POINT-SIZE="15" COLOR="#f5b2a3">Existing dashboard surface. The bridge<BR/>translates behavior here instead<BR/>of pretending the old system disappeared.</FONT></TD></TR></TABLE>>,
...
<!-- Generated by graphviz version 14.1.5 (0)
 -->
<!-- Pages: 1 -->
<svg width="910pt" height="1236pt"
 viewBox="0.00 0.00 910.00 1236.00" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
<g id="graph0" class="graph" transform="scale(1 1) rotate(0) translate(15.05 1220.65)">
<g id="clust1" class="cluster">
<title>cluster_aiworkflowsystem</title>
<polygon fill="#3e4651" stroke="#2d333d" points="8,-8 8,-934.8 872,-934.8 872,-8 8,-8"/>
...
<polygon fill="#ac4d39" stroke="#853a2d" stroke-width="0" points="392.2,-873.6 47.8,-873.6 47.8,-693.6 392.2,-693.6 392.2,-873.6"/>
<text xml:space="preserve" text-anchor="start" x="129.97" y="-804.6" font-family="Arial" font-size="20.00" fill="#fbd3cb">Raycast Commands</text>
<text xml:space="preserve" text-anchor="start" x="75.77" y="-781.6" font-family="Arial" font-size="15.00" fill="#f5b2a3">Command UI for Scout Prep, Set Meetings,</text>
<text xml:space="preserve" text-anchor="start" x="127.86" y="-763.6" font-family="Arial" font-size="15.00" fill="#f5b2a3">Client Messages, and video</text>
<text xml:space="preserve" text-anchor="start" x="67.86" y="-745.6" font-family="Arial" font-size="15.00" fill="#f5b2a3">workflow commands. Commands are buttons.</text>
</g>
<!-- prospectweb -->
<g id="node2" class="node">
<title>prospectweb</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="832.13,-873.6 501.87,-873.6 501.87,-693.6 832.13,-693.6 832.13,-873.6"/>
<text xml:space="preserve" text-anchor="start" x="567.52" y="-804.6" font-family="Arial" font-size="20.00" fill="#eff6ff">Vercel / Prospect Web</text>
<text xml:space="preserve" text-anchor="start" x="521.93" y="-781.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">Public and mobile review surface that reads</text>
<text xml:space="preserve" text-anchor="start" x="566.52" y="-763.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">cleaned workflow data outside</text>
<text xml:space="preserve" text-anchor="start" x="563.2" y="-745.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">the Raycast command window.</text>
</g>
<!-- fastapibridge -->
<g id="node3" class="node">
<title>fastapibridge</title>
<polygon fill="#a35829" stroke="#7e451d" stroke-width="0" points="380.02,-550.8 59.98,-550.8 59.98,-370.8 380.02,-370.8 380.02,-550.8"/>
<text xml:space="preserve" text-anchor="start" x="126.06" y="-481.8" font-family="Arial" font-size="20.00" fill="#ffe0c2">Local FastAPI Bridge</text>
<text xml:space="preserve" text-anchor="start" x="80.75" y="-458.8" font-family="Arial" font-size="15.00" fill="#f9b27c">Adapter layer that turns legacy dashboard</text>
<text xml:space="preserve" text-anchor="start" x="122.44" y="-440.8" font-family="Arial" font-size="15.00" fill="#f9b27c">form behavior into repeatable</text>
<text xml:space="preserve" text-anchor="start" x="93.67" y="-422.8" font-family="Arial" font-size="15.00" fill="#f9b27c">request shapes and readback checks.</text>
</g>
<!-- legacylaravel -->
<g id="node4" class="node">
<title>legacylaravel</title>
<polygon fill="#ac4d39" stroke="#853a2d" stroke-width="0" points="380.02,-228 59.98,-228 59.98,-48 380.02,-48 380.02,-228"/>
<text xml:space="preserve" text-anchor="start" x="100.48" y="-159" font-family="Arial" font-size="20.00" fill="#fbd3cb">Legacy Laravel Dashboard</text>
<text xml:space="preserve" text-anchor="start" x="89.51" y="-136" font-family="Arial" font-size="15.00" fill="#f5b2a3">Existing dashboard surface. The bridge</text>
<text xml:space="preserve" text-anchor="start" x="113.27" y="-118" font-family="Arial" font-size="15.00" fill="#f5b2a3">translates behavior here instead</text>
<text xml:space="preserve" text-anchor="start" x="80.33" y="-100" font-family="Arial" font-size="15.00" fill="#f5b2a3">of pretending the old system disappeared.</text>
</g>
<!-- supabasetruth -->
<g id="node5" class="node">
<title>supabasetruth</title>
<polygon fill="#428a4f" stroke="#2d5d39" stroke-width="0" points="818.02,-228 497.98,-228 497.98,-48 818.02,-48 818.02,-228"/>
<text xml:space="preserve" text-anchor="start" x="555.71" y="-159" font-family="Arial" font-size="20.00" fill="#f8fafc">Supabase PostgreSQL</text>
<text xml:space="preserve" text-anchor="start" x="529.61" y="-136" font-family="Arial" font-size="15.00" fill="#c2f0c2">Source&#45;of&#45;truth layer for appointments,</text>
<text xml:space="preserve" text-anchor="start" x="559.63" y="-118" font-family="Arial" font-size="15.00" fill="#c2f0c2">lifecycle events, call log rows,</text>
<text xml:space="preserve" text-anchor="start" x="593.8" y="-100" font-family="Arial" font-size="15.00" fill="#c2f0c2">and reporting facts.</text>
</g>
<!-- portfoliooperator -->
<g id="node6" class="node">
<title>portfoliooperator</title>
<polygon fill="#a35829" stroke="#7e451d" stroke-width="0" points="401.38,-1205.6 38.62,-1205.6 38.62,-1025.6 401.38,-1025.6 401.38,-1205.6"/>
<text xml:space="preserve" text-anchor="start" x="180.54" y="-1154.6" font-family="Arial" font-size="20.00" fill="#ffe0c2">Operator</text>
<text xml:space="preserve" text-anchor="start" x="58.68" y="-1131.6" font-family="Arial" font-size="15.00" fill="#f9b27c">The working user. Uses the command surface to</text>
<text xml:space="preserve" text-anchor="start" x="134.54" y="-1113.6" font-family="Arial" font-size="15.00" fill="#f9b27c">move practical operations</text>
<text xml:space="preserve" text-anchor="start" x="81.19" y="-1095.6" font-family="Arial" font-size="15.00" fill="#f9b27c">workflow steps without repeatedly clicking</text>
<text xml:space="preserve" text-anchor="start" x="124.1" y="-1077.6" font-family="Arial" font-size="15.00" fill="#f9b27c">through scattered dashboard</text>
<text xml:space="preserve" text-anchor="start" x="191.66" y="-1059.6" font-family="Arial" font-size="15.00" fill="#f9b27c">screens.</text>
</g>
<!-- raycastcommands&#45;&gt;fastapibridge -->
<g id="edge2" class="edge">
<title>raycastcommands&#45;&gt;fastapibridge</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M220,-693.67C220,-652.47 220,-603.36 220,-560.97"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="222.63,-561.16 220,-553.66 217.38,-561.16 222.63,-561.16"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="220,-610.8 220,-633.6 381.65,-633.6 381.65,-610.8 220,-610.8"/>
<text xml:space="preserve" text-anchor="start" x="223" y="-616.6" font-family="Arial" font-size="14.00" fill="#c9c9c9">sends command payload</text>
</g>
<!-- prospectweb&#45;&gt;supabasetruth -->
<g id="edge3" class="edge">
<title>prospectweb&#45;&gt;supabasetruth</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M665.76,-693.79C664.09,-574.38 661.13,-362.73 659.39,-238.23"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="662.02,-238.42 659.29,-230.96 656.77,-238.5 662.02,-238.42"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="663.69,-449.4 663.69,-472.2 788.78,-472.2 788.78,-449.4 663.69,-449.4"/>
<text xml:space="preserve" text-anchor="start" x="666.69" y="-455.2" font-family="Arial" font-size="14.00" fill="#c9c9c9">reads cleaned data</text>
</g>
<!-- fastapibridge&#45;&gt;legacylaravel -->
<g id="edge4" class="edge">
<title>fastapibridge&#45;&gt;legacylaravel</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M203.18,-371.23C199.82,-344.53 197.81,-315.12 199.66,-288 200.76,-271.82 202.52,-254.72 204.56,-238.1"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="207.14,-238.6 205.48,-230.83 201.93,-237.94 207.14,-238.6"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="199.66,-288 199.66,-310.8 394,-310.8 394,-288 199.66,-288"/>
<text xml:space="preserve" text-anchor="start" x="202.66" y="-293.8" font-family="Arial" font-size="14.00" fill="#c9c9c9">translates dashboard behavior</text>
</g>
<!-- fastapibridge&#45;&gt;supabasetruth -->
<g id="edge5" class="edge">
<title>fastapibridge&#45;&gt;supabasetruth</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M341.43,-370.87C399.58,-328.27 469.27,-277.23 528.44,-233.89"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="529.78,-236.17 534.28,-229.62 526.67,-231.93 529.78,-236.17"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="452.13,-288 452.13,-310.8 578.74,-310.8 578.74,-288 452.13,-288"/>
<text xml:space="preserve" text-anchor="start" x="455.13" y="-293.8" font-family="Arial" font-size="14.00" fill="#c9c9c9">writes durable facts</text>
</g>
<!-- portfoliooperator&#45;&gt;raycastcommands -->
<g id="edge1" class="edge">
<title>portfoliooperator&#45;&gt;raycastcommands</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M220,-1025.73C220,-981.9 220,-928.88 220,-883.74"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="222.63,-883.87 220,-876.37 217.38,-883.87 222.63,-883.87"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="220,-942.8 220,-965.6 372.28,-965.6 372.28,-942.8 220,-942.8"/>
<text xml:space="preserve" text-anchor="start" x="223" y="-948.6" font-family="Arial" font-size="14.00" fill="#c9c9c9">triggers workflow action</text>
</g>
</g>
</svg>
...
<!-- Generated by graphviz version 14.1.5 (0)
 -->
<!-- Pages: 1 -->
<svg width="1980pt" height="210pt"
 viewBox="0.00 0.00 1980.00 210.00" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<g id="node2" class="node">
<title>bucket2</title>
<polygon fill="#a35829" stroke="#7e451d" stroke-width="0" points="743.46,-180 423.42,-180 423.42,0 743.46,0 743.46,-180"/>
<text xml:space="preserve" text-anchor="start" x="510.72" y="-84.4" font-family="Arial" font-size="14.00" fill="#ffe0c2"> </text>
<text xml:space="preserve" text-anchor="start" x="569.67" y="-93" font-family="Arial" font-size="20.00" fill="#ffe0c2">2. Prep</text>
<text xml:space="preserve" text-anchor="start" x="697.26" y="-84.4" font-family="Arial" font-size="14.00" fill="#ffe0c2"> </text>
<text xml:space="preserve" text-anchor="start" x="569.67" y="-70" font-family="Arial" font-size="15.00" fill="#f9b27c">Pre&#45;meeting work</text>
</g>
<!-- bucket3 -->
<g id="node3" class="node">
<title>bucket3</title>
<polygon fill="#428a4f" stroke="#2d5d39" stroke-width="0" points="1143.5,-180 823.46,-180 823.46,0 1143.5,0 1143.5,-180"/>
<text xml:space="preserve" text-anchor="start" x="895.62" y="-84.4" font-family="Arial" font-size="14.00" fill="#f8fafc"> </text>
<text xml:space="preserve" text-anchor="start" x="954.57" y="-93" font-family="Arial" font-size="20.00" fill="#f8fafc">3. Client Comms</text>
<text xml:space="preserve" text-anchor="start" x="1112.44" y="-84.4" font-family="Arial" font-size="14.00" fill="#f8fafc"> </text>
<text xml:space="preserve" text-anchor="start" x="954.57" y="-70" font-family="Arial" font-size="15.00" fill="#c2f0c2">Messages and calls</text>
</g>
<!-- bucket4 -->
<g id="node4" class="node">
<title>bucket4</title>
<polygon fill="#0284c7" stroke="#0369a1" stroke-width="0" points="1543.57,-180 1223.5,-180 1223.5,0 1543.57,0 1543.57,-180"/>
<text xml:space="preserve" text-anchor="start" x="1286.61" y="-84.4" font-family="Arial" font-size="14.00" fill="#f0f9ff"> </text>
<text xml:space="preserve" text-anchor="start" x="1345.56" y="-93" font-family="Arial" font-size="20.00" fill="#f0f9ff">4. Lifecycle</text>
<text xml:space="preserve" text-anchor="start" x="1521.56" y="-84.4" font-family="Arial" font-size="14.00" fill="#f0f9ff"> </text>
<text xml:space="preserve" text-anchor="start" x="1345.56" y="-70" font-family="Arial" font-size="15.00" fill="#b6ecf7">Stage and reporting truth</text>
</g>
<!-- bucket5 -->
<g id="node5" class="node">
<title>bucket5</title>
<polygon fill="#ac4d39" stroke="#853a2d" stroke-width="0" points="1950.28,-180 1623.57,-180 1623.57,0 1950.28,0 1950.28,-180"/>
<text xml:space="preserve" text-anchor="start" x="1686.69" y="-84.4" font-family="Arial" font-size="14.00" fill="#fbd3cb"> </text>
<text xml:space="preserve" text-anchor="start" x="1745.63" y="-93" font-family="Arial" font-size="20.00" fill="#fbd3cb">5. Outcomes</text>
<text xml:space="preserve" text-anchor="start" x="1928.28" y="-84.4" font-family="Arial" font-size="14.00" fill="#fbd3cb"> </text>
<text xml:space="preserve" text-anchor="start" x="1745.63" y="-70" font-family="Arial" font-size="15.00" fill="#f5b2a3">Enrollments and follow&#45;up</text>
</g>
<!-- bucket1&#45;&gt;bucket2 -->
<g id="edge1" class="edge">
<title>bucket1&#45;&gt;bucket2</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M343.21,-90C366.37,-90 390.13,-90 413.26,-90"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="412.96,-92.63 420.46,-90 412.96,-87.38 412.96,-92.63"/>
</g>
<!-- bucket2&#45;&gt;bucket3 -->
<g id="edge2" class="edge">
<title>bucket2&#45;&gt;bucket3</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M743.18,-90C766.21,-90 789.98,-90 813.21,-90"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="812.95,-92.63 820.45,-90 812.95,-87.38 812.95,-92.63"/>
</g>
<!-- bucket3&#45;&gt;bucket4 -->
<g id="edge3" class="edge">
<title>bucket3&#45;&gt;bucket4</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1143.23,-90C1166.25,-90 1190.03,-90 1213.26,-90"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="1213,-92.63 1220.5,-90 1213,-87.38 1213,-92.63"/>
</g>
<!-- bucket4&#45;&gt;bucket5 -->
<g id="edge4" class="edge">
<title>bucket4&#45;&gt;bucket5</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1543.46,-90C1566.45,-90 1590.2,-90 1613.44,-90"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="1613.19,-92.63 1620.69,-90 1613.19,-87.38 1613.19,-92.63"/>
</g>
</g>
</svg>

...
function recordVerifiedReceipt(transaction, entry, adapterEvidence, options = {}) {
  ...
  appendAttempt(transaction, entry, options.outcome ?? "verified", options.clock, options.detail ?? null);
  return receipt;
}
  ...
  for (const owner of transaction.declaredOwners) {
    ...
    try {
      ...
      if (reconcileOnly) {
        ...
        recordVerifiedReceipt(transaction, entry, adapterEvidence, options);
        continue;
      }
      ...
      if (resumingUncertainMutation) {
        ...
        recordVerifiedReceipt(transaction, entry, adapterEvidence, {
          ...options,
          outcome: "recovered",
          detail: "prepared mutation verified without replay",
        });
        continue;
      }

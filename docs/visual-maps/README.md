...
Keep node titles operator-facing. Put the actual rule in LikeC4 `description`
fields so the Properties panel explains what each surface owns and what must
not drift.

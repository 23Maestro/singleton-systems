...
`;case`opportunity_hq_container_map`:return`digraph {
    ...
    subgraph cluster_durable {
        ...
        tasks [color="#0369a1",
            ...
            group=durable,
            height=2.389,
            label=<<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="4"><TR><TD><FONT POINT-SIZE="20">Opportunity Tasks</FONT></TD></TR><TR><TD><FONT POINT-SIZE="15" COLOR="#B6ECF7">Executable work. Fields: Task, Bucket,<BR/>Status, Time, Money Priority,<BR/>Project, Work Date, Block, Link, Asset /<BR/>Proof Link, Next, Notes.<BR/>Status contract: Queued, Today, In Motion,</FONT></TD></TR></TABLE>>,
    ...
    updatetask [height=2.5,
        label=<<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="4"><TR><TD><FONT POINT-SIZE="20">Update Task</FONT></TD></TR><TR><TD><FONT POINT-SIZE="15" COLOR="#bfdbfe">Update Status, Next, Work Date, Block, Money<BR/>Priority, Project, Link, or<BR/>Notes on an existing Opportunity Task.</FONT></TD></TR></TABLE>>,
...
<!-- Generated by graphviz version 14.1.5 (0)
 -->
<!-- Pages: 1 -->
<svg width="2646pt" height="1245pt"
 viewBox="0.00 0.00 2646.00 1245.00" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<text xml:space="preserve" text-anchor="start" x="140.8" y="-432" font-family="Arial" font-size="15.00" fill="#b6ecf7">Proof Link, Next, Notes.</text>
...
<title>operator</title>
<polygon fill="#a35829" stroke="#7e451d" stroke-width="0" points="1463.65,-1214.8 1118.35,-1214.8 1118.35,-1034.8 1463.65,-1034.8 1463.65,-1214.8"/>
<text xml:space="preserve" text-anchor="start" x="1251.54" y="-1163.8" font-family="Arial" font-size="20.00" fill="#ffe0c2">Operator</text>
<text xml:space="preserve" text-anchor="start" x="1155.52" y="-1140.8" font-family="Arial" font-size="15.00" fill="#f9b27c">The working user. Uses mobile, desktop,</text>
<text xml:space="preserve" text-anchor="start" x="1175.52" y="-1122.8" font-family="Arial" font-size="15.00" fill="#f9b27c">Raycast, Codex, Notion, Bear, and</text>
<text xml:space="preserve" text-anchor="start" x="1141.34" y="-1104.8" font-family="Arial" font-size="15.00" fill="#f9b27c">Eagle to move job search, Upwork, Singleton</text>
<text xml:space="preserve" text-anchor="start" x="1196.37" y="-1086.8" font-family="Arial" font-size="15.00" fill="#f9b27c">offer, and proof work without</text>
<text xml:space="preserve" text-anchor="start" x="1138.4" y="-1068.8" font-family="Arial" font-size="15.00" fill="#f9b27c">repeatedly deciding where each item belongs.</text>
</g>
<!-- logtask -->
<g id="node9" class="node">
<title>logtask</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="2172.46,-1214.8 1845.54,-1214.8 1845.54,-1034.8 2172.46,-1034.8 2172.46,-1214.8"/>
<text xml:space="preserve" text-anchor="start" x="1967.87" y="-1154.8" font-family="Arial" font-size="20.00" fill="#eff6ff">Log Task</text>
<text xml:space="preserve" text-anchor="start" x="1869.77" y="-1131.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">Create an Opportunity Task from selected</text>
<text xml:space="preserve" text-anchor="start" x="1920.2" y="-1113.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">text, clipboard link, manual</text>
<text xml:space="preserve" text-anchor="start" x="1865.6" y="-1095.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">form input, or mobile/share context. Default</text>
<text xml:space="preserve" text-anchor="start" x="1954.8" y="-1077.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">Status: Queued.</text>
</g>
<!-- updatetask -->
<g id="node10" class="node">
<title>updatetask</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="2184.95,-882.8 1833.05,-882.8 1833.05,-702.8 2184.95,-702.8 2184.95,-882.8"/>
<text xml:space="preserve" text-anchor="start" x="1952.31" y="-813.8" font-family="Arial" font-size="20.00" fill="#eff6ff">Update Task</text>
<text xml:space="preserve" text-anchor="start" x="1853.1" y="-790.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">Update Status, Next, Work Date, Block, Money</text>
<text xml:space="preserve" text-anchor="start" x="1929.39" y="-772.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">Priority, Project, Link, or</text>
<text xml:space="preserve" text-anchor="start" x="1879.77" y="-754.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">Notes on an existing Opportunity Task.</text>
</g>
<!-- plantoday -->
<g id="node11" class="node">
<title>plantoday</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="2180.37,-560 1837.63,-560 1837.63,-380 2180.37,-380 2180.37,-560"/>
<text xml:space="preserve" text-anchor="start" x="1958.41" y="-491" font-family="Arial" font-size="20.00" fill="#eff6ff">Plan Today</text>
<text xml:space="preserve" text-anchor="start" x="1857.69" y="-468" font-family="Arial" font-size="15.00" fill="#bfdbfe">Assign Work Date and Block. Moves selected</text>
<text xml:space="preserve" text-anchor="start" x="1905.19" y="-450" font-family="Arial" font-size="15.00" fill="#bfdbfe">queue items into Today without</text>
<text xml:space="preserve" text-anchor="start" x="1887.68" y="-432" font-family="Arial" font-size="15.00" fill="#bfdbfe">changing their real bucket or project.</text>
</g>
<!-- startapplication -->
<g id="node12" class="node">
<title>startapplication</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="2169.02,-228 1848.98,-228 1848.98,-48 2169.02,-48 2169.02,-228"/>
<text xml:space="preserve" text-anchor="start" x="1936.18" y="-159" font-family="Arial" font-size="20.00" fill="#eff6ff">Start Application</text>
<text xml:space="preserve" text-anchor="start" x="1871" y="-136" font-family="Arial" font-size="15.00" fill="#bfdbfe">Open a job link and resume path from the</text>
<text xml:space="preserve" text-anchor="start" x="1906.03" y="-118" font-family="Arial" font-size="15.00" fill="#bfdbfe">selected task. Move the task to</text>
<text xml:space="preserve" text-anchor="start" x="1909.8" y="-100" font-family="Arial" font-size="15.00" fill="#bfdbfe">In Motion while work is active.</text>
</g>
<!-- draftproposal -->
<g id="node13" class="node">
<title>draftproposal</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="2615.97,-1214.8 2294.03,-1214.8 2294.03,-1034.8 2615.97,-1034.8 2615.97,-1214.8"/>
<text xml:space="preserve" text-anchor="start" x="2391.08" y="-1145.8" font-family="Arial" font-size="20.00" fill="#eff6ff">Draft Proposal</text>
<text xml:space="preserve" text-anchor="start" x="2314.09" y="-1122.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">Turn a copied Upwork post into a proposal</text>
<text xml:space="preserve" text-anchor="start" x="2368.7" y="-1104.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">draft and log the follow&#45;up</text>
<text xml:space="preserve" text-anchor="start" x="2356.2" y="-1086.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">state back to Opportunity HQ.</text>
</g>
<!-- captureproof -->
<g id="node14" class="node">
<title>captureproof</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="2615.02,-882.8 2294.98,-882.8 2294.98,-702.8 2615.02,-702.8 2615.02,-882.8"/>
<text xml:space="preserve" text-anchor="start" x="2392.74" y="-831.8" font-family="Arial" font-size="20.00" fill="#eff6ff">Capture Proof</text>
<text xml:space="preserve" text-anchor="start" x="2317" y="-808.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">Import the selected asset to Eagle, attach</text>
<text xml:space="preserve" text-anchor="start" x="2365.78" y="-790.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">the proof link or note to the</text>
<text xml:space="preserve" text-anchor="start" x="2315.77" y="-772.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">selected Opportunity Task, then mark that</text>
<text xml:space="preserve" text-anchor="start" x="2345.78" y="-754.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">task Done when the proof item is</text>
<text xml:space="preserve" text-anchor="start" x="2422.48" y="-736.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">complete.</text>
</g>
<!-- proof -->
...
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1239.83,-1034.93C1214.33,-990.64 1183.43,-936.97 1157.26,-891.52"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="1159.62,-890.35 1153.6,-885.16 1155.07,-892.97 1159.62,-890.35"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1201.7,-952 1201.7,-974.8 1254.39,-974.8 1254.39,-952 1201.7,-952"/>
<text xml:space="preserve" text-anchor="start" x="1204.7" y="-957.8" font-family="Arial" font-size="14.00" fill="#c9c9c9">capture</text>
</g>
<!-- operator&#45;&gt;mobileform -->
<g id="edge2" class="edge">
<title>operator&#45;&gt;mobileform</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1360.75,-1034.93C1395.73,-990.36 1438.16,-936.3 1473.98,-890.66"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="1475.92,-892.44 1478.48,-884.92 1471.79,-889.2 1475.92,-892.44"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1420.5,-952 1420.5,-974.8 1445.18,-974.8 1445.18,-952 1420.5,-952"/>
<text xml:space="preserve" text-anchor="start" x="1423.5" y="-957.8" font-family="Arial" font-size="14.00" fill="#c9c9c9">log</text>
</g>
<!-- logtask&#45;&gt;updatetask -->
...
<!-- Generated by graphviz version 14.1.5 (0)
 -->
<!-- Pages: 1 -->
<svg width="1370pt" height="922pt"
 viewBox="0.00 0.00 1370.00 922.00" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<text xml:space="preserve" text-anchor="start" x="135.8" y="-100" font-family="Arial" font-size="15.00" fill="#b6ecf7">Proof Link, Next, Notes.</text>
...
<g id="node7" class="node">
<title>updatetask</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="1339.95,-560 988.05,-560 988.05,-380 1339.95,-380 1339.95,-560"/>
<text xml:space="preserve" text-anchor="start" x="1107.31" y="-491" font-family="Arial" font-size="20.00" fill="#eff6ff">Update Task</text>
<text xml:space="preserve" text-anchor="start" x="1008.1" y="-468" font-family="Arial" font-size="15.00" fill="#bfdbfe">Update Status, Next, Work Date, Block, Money</text>
<text xml:space="preserve" text-anchor="start" x="1084.39" y="-450" font-family="Arial" font-size="15.00" fill="#bfdbfe">Priority, Project, Link, or</text>
<text xml:space="preserve" text-anchor="start" x="1034.77" y="-432" font-family="Arial" font-size="15.00" fill="#bfdbfe">Notes on an existing Opportunity Task.</text>
</g>
<!-- plantoday -->
<g id="node8" class="node">
<title>plantoday</title>
...
<text xml:space="preserve" text-anchor="start" x="623.8" y="-432" font-family="Arial" font-size="15.00" fill="#b6ecf7">Proof Link, Next, Notes.</text>
